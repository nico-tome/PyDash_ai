...
lvl = pygame.image.load('asset/level_2.png')
pygame.mixer.music.load('asset/explode.mp3')
...
mod = get_settings(0)
filepath_ = 'data/agents.csv' if mod == 'train' else 'data/best.csv'
print(filepath_)
...
by_id = 0
if mod == 'train':
    generation = get_generation('data/best.csv') + 1
